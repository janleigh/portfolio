			...
			<div className="mt-24 flex w-full flex-1 flex-col items-center px-margin-mobile md:px-margin-desktop">
				<div className="w-full max-w-6xl">
					...
					{loading ? (
						...
						<div className="py-20 text-center font-label-md text-normal-red">
							Error: {error}
						</div>
					) : (
						<motion.div
									...
									<div className="parallax-card flex h-full flex-col justify-between overflow-hidden rounded border border-[#42474f] bg-normal-black transition-colors duration-300 hover:bg-bright-black">
										...
										<div className="flex flex-1 flex-col p-6">
											<div className="mb-4 flex items-start justify-between">
												<h3 className="font-headline-lg-mobile text-[20px] text-bright-cyan transition-colors group-hover:text-primary-fg">
													{repo.name}
												</h3>
												<svg
											...
											<p className="mb-6 line-clamp-3 font-caption-sm text-[14px] leading-relaxed text-primary-fg/70">
											...
											<div className="mt-auto flex items-center gap-4 border-t border-[#42474f]/30 pt-4">
												{repo.language && (
													<div className="flex items-center gap-1.5">
														...
														<span className="font-label-md text-[12px] text-primary-fg/80">
															{repo.language}
														</span>
													</div>
												)}
