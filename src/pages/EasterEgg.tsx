...
export default function EasterEgg() {
	...
	useEffect(() => {
		...
		const ctx = gsap.context(() => {
			...
			const noteEls: HTMLElement[] = noteElFn(music.note) as HTMLElement[];
	...
	return (
		<div className="bg-grid-pattern bongo-cat-wrapper" ref={containerRef}>
			<audio src="/Conga.ogg" autoPlay loop />
			<Link
				to="/"
				className="fixed top-4 left-4 z-50 p-4 text-[#ffcc81] transition-colors hover:text-[#ff61d8]">
				<svg
